...
class DialogCalendar:
    months = ["Янв", "Февр", "Март", "Апрель", "Май", "Июнь", "Июль", "Август", "Сен", "Окт", "Ноя", "Дек"]

    def __init__(self, year: int = 2006, month: int = datetime.now().month):
        self.year = year
        self.month = month
    ...
    async def start_calendar(
        ...
        # first row - years
        inline_kb.row()
        for value in range(year - 5, year + 10):
